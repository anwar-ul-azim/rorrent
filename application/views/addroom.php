    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><h4 class="text-uppercase">Add Your Room Info</h4></center>
            <hr>
            <div class="form-group col-md-12">
                ...
                <input name="NUMBER_OF_MEMBERS" style="text-align:center;" class="form-control" placeholder="Number of Member" value="<?php echo set_value('NUMBER_OF_MEMBERS'); ?>"><br />
               ...
               <center><input type="submit" class="btn btn-primary" value="Add Room Info"/></center>
            </div>
