            ...
            <div class="col-md-4">
                ...
                <div class="well">
                    ...
                    <div class="input-group col-md-12">
                        <input name="BASE_RENT_SEARCH" type="text" class="form-control" value="<?php echo set_value("BASE_RENT_SEARCH"); ?>">
                    </div>
                    <!-- /.input-group -->
                    <h4>Type [Room or Flat]</h4>
                    <div class="input-group col-md-12">
                        <input name="TYPE_SEARCH" type="text" class="form-control" value="<?php echo set_value("TYPE_SEARCH"); ?>">
                    </div>
                    <h4>Number of Bedrooms</h4>
                    <div class="input-group col-md-12">
                        <input name="NUMBER_OF_BEDROOM_SEARCH" type="text" class="form-control" value="<?php echo set_value("NUMBER_OF_BEDROOM_SEARCH"); ?>">
                    </div>
                    <!-- /.input-group -->
                    <h4>Total Area [in Square Feet]</h4>
                    <div class="input-group col-md-12">
                        <input name="SQ_FEET_SEARCH" type="text" class="form-control" value="<?php echo set_value("SQ_FEET_SEARCH"); ?>">
                    </div>
                    <h4>Location</h4>
                    <div class="input-group col-md-12">
