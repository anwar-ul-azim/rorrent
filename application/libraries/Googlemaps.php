...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCdKxsYVotig9Og43FnW0TSgTOw1b0NSg0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	//make a change here-------------------------------------------------------------------------------------------------------------------------------------------------------------
	function Googlemap_s($config = array())
	{
		if (count($config) > 0)
		{
